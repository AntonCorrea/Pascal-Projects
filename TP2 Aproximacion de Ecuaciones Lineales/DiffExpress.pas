  ...
  begin
    ...
    case s[pos] of
      ...
      begin
        ...
        dec(pos);
        num := 8;
        if (con = 'cos') or (con = 'COS') then num := 10;
        if (con = 'sin') or (con = 'SIN') then num := 11;
        if (con = 'tang') or (con = 'TANG') then num := 12;
        if (con = 'cotg') or (con = 'COTG') then num := 13;
        if (con = 'abs') or (con = 'ABS') then num := 14;
        if (con = 'sgn') or (con = 'sign') or (con = 'SGN') or (con = 'SIGN') then num := 15;
        if (con = 'sqrt') or (con = 'SQRT') then num := 16;
        if (con = 'ln') or (con = 'LN') then num := 17;
        if (con = 'exp') or (con = 'EXP') then num := 18;
        if (con = 'asin') or (con = 'ASIN') then num := 19;
        if (con = 'acos') or (con = 'ACOS') then num := 20;
        if (con = 'atang') or (con = 'ATANG') then num := 21;
        if (con = 'acotg') or (con = 'ACOTG') then num := 22;
        if (con = 'sinh') or (con = 'SINH') then num := 23;
        if (con = 'cosh') or (con = 'COSH') then num := 24;
        if (con = 'tangh') or (con = 'TANGH') then num := 25;
        if (con = 'cotgh') or (con = 'COTGH') then num := 26;
